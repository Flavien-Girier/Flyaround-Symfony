...
/* site/show.html.twig */
class __TwigTemplate_af394c80d2c918bac548ba5c0b59ce82426d4c7856a61cfb97b7f0194f32860e extends Twig_Template
{
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute(($context["site"] ?? $this->getContext($context, "site")), "longitude", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>City</th>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("site_edit", array("id" => $this->getAttribute(($context["site"] ?? $this->getContext($context, "site")), "id", array()))), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
{% endblock %}
", "site/show.html.twig", "/home/wilder/WCS/Quête/FlyAround/app/Resources/views/site/show.html.twig");
    }
}
