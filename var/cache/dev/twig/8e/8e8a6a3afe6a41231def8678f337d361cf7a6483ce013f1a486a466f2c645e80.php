...
class __TwigTemplate_4db7e0f4dc4b1dcaafedde630148762666f7bc4cec1a1303492850e86ca4d350 extends Twig_Template
{
    ...
    <table>
        ...
        <tr>
            ...
            <th>";
        // line 42
        if (($context["timeTravel"] ?? $this->getContext($context, "timeTravel"))) {
            echo twig_escape_filter($this->env, ($context["timeTravel"] ?? $this->getContext($context, "timeTravel")), "html", null, true);
        }
        echo "</th>
        </tr>
        </tbody>
...
";
    ...
    {
        return array (  153 => 57,  148 => 55,  142 => 52,  136 => 49,  124 => 42,  114 => 38,  103 => 34,  96 => 30,  87 => 26,  78 => 22,  71 => 18,  64 => 14,  57 => 10,  49 => 4,  40 => 3,  11 => 1,);
    }
...
{% block body %}
    ...
    <table>
        ...
        <tr>
            <th>Distance</th>
            <th>{% if distance %}{{ distance|number_format(2, ',', ' ') }}{% endif %}{{ unit }}</th>
        </tr>
        <tr>
            <th>Travel Time</th>
            <th>{% if timeTravel %}{{ timeTravel}}{% endif %}</th>
        </tr>
        </tbody>
    </table>
